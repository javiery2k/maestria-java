...
public class Login extends JFrame {
	...
	public Login() {
		 ...
		 * Etiquetas
		 */
		JLabel lblNewLabel_2 = new JLabel("AUTOMOTRIZ");
		lblNewLabel_2.setForeground(color2);
		lblNewLabel_2.setFont(new Font("SansSerif", Font.PLAIN, 18));
		lblNewLabel_2.setBounds(104, 239, 119, 24);
		panel.add(lblNewLabel_2);

		JLabel lblNewLabel_2_1 = new JLabel("SISTEMA DE INVENTARIO");
		lblNewLabel_2_1.setForeground(new Color(42, 88, 173));
		lblNewLabel_2_1.setFont(new Font("SansSerif", Font.PLAIN, 18));
		lblNewLabel_2_1.setBounds(49, 214, 225, 24);
		panel.add(lblNewLabel_2_1);

		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(Login.class.getResource("/assets/logo.png")));
		lblNewLabel_3.setBounds(60, 59, 200, 129);
		...
		lblNewLabel.setIcon(new ImageIcon(Login.class.getResource("/assets/icons8_customer_32px_1.png")));
		lblNewLabel.setBounds(31, 101, 32, 32);
		panel_1.add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/assets/icons8_Key_32px.png")));
